...
ActiveRecord::Schema.define(version: 2020_01_28_172914) do
  ...
  create_table "book_items", force: :cascade do |t|
    ...
    t.index ["location_id"], name: "index_book_items_on_location_id"
  ...
  create_table "checkout_records", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["book_item_id"], name: "index_checkout_records_on_book_item_id"
    t.index ["user_id"], name: "index_checkout_records_on_user_id"
  end
  ...
  add_foreign_key "book_items", "locations"
